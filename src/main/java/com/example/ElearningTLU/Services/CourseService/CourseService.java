...
//                    this.courseRepository.delete(course);
        ...
        Course course = new Course();
               course=this.mapper.map(courseRequest,Course.class);
                ...
                System.out.println(courseRequest.getType());
        System.out.println(courseRequest.getType().equals(CourseType.COSO));

        StatisticsStudent statisticsStudent = new StatisticsStudent();
        if(courseRequest.getType().equals(CourseType.COSO))
        {
...
//            statisticsStudent.setCourse(course);
        ...
        else if (courseRequest.getType().equals(CourseType.COSONGANH))
        {
...
//                this.courseRepository.delete(course);
            ...
            for(String id : courseRequest.getDepartmentId()) {
                ...
                course.getListDepartment().add(courseDepartment);
...
//        this.clearData(course.get());
        this.courseRepository.delete(this.courseRepository.findByCourseId(id));
